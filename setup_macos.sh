...
read -p "Give message for lock screen, e.g. John Doe, johndoe@example.com / +358 123 4567`echo $'\n> '`" message
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText "$message"
echo "Set lock screen message to: $message"
...
# Set view for all Finder windows by default
...
defaults write com.apple.dock mru-spaces -bool falseo
